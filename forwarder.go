...
func WithForwardersEmbedConfig(ctx context.Context, logStreams genericclioptions.IOStreams, options []*Option, kubeconfigBytes []byte) (*Result, error) {
	...
	return forwarders(ctx, logStreams, options, config)
}
...
func WithForwarders(ctx context.Context, logStreams genericclioptions.IOStreams, options []*Option, kubeconfigPath string) (*Result, error) {
	if kubeconfigPath == "" {
...
func WithRestConfig(ctx context.Context, logStreams genericclioptions.IOStreams, options []*Option, config *restclient.Config) (*Result, error) {
	return forwarders(ctx, logStreams, options, config)
}

// It is to forward port for k8s cloud services.
func forwarders(ctx context.Context, logStreams genericclioptions.IOStreams, options []*Option, config *restclient.Config) (*Result, error) {
